...
const AuditingMainPage = () => {
  const navigate = useNavigate();

  const auditServices = [
    {
      img: "/images/Book_Day_To_Day.png",
      title: "Bookkeeping & Day-to-Day Accounting",
      desc: "Efficiently manage your daily financial transactions, maintain accurate ledgers, and ensure smooth accounting operations.",
      btn: "Learn More",
    },
    {
      img: "images/FInancial_Reporting.png",
      title: "Financial Reporting & Statements",
      desc: "Prepare clear and comprehensive financial statements to make informed business decisions and ensure compliance.",
      btn: "Learn More",
    },
    {
      img: "images/Tax_Planing.png",
      title: "Tax Compliance & Planning",
      desc: "Optimize tax obligations and ensure full compliance with regulatory requirements, minimizing liabilities.",
      btn: "Learn More",
    },
    {
      img: "images/Auditing_Assurance.png",
      title: "Auditing & Assurance Services",
      desc: "Conduct thorough audits to evaluate financial health, identify risks, and assure accuracy and transparency.",
      btn: "Learn More",
    },
    {
      img: "images/PayRoll.png",
      title: "Payroll & Employee Compliance",
      desc: "Manage employee payroll efficiently while staying compliant with labor laws and tax regulations.",
      btn: "Learn More",
    },
    {
      img: "images/Budget_Forecasting.png",
      title: "Budgeting, Forecasting & Insights",
      desc: "Plan, forecast, and analyze your finances to make smarter business decisions with actionable insights.",
      btn: "Learn More",
    },
    {
      img: "images/Specialised_Accounting.png",
      title: "Specialised Accounting Solutions",
      desc: "Tailored accounting services for specific industries to meet unique business and compliance needs.",
      btn: "Learn More",
    },
    {
      img: "images/Business_Advisory.png",
      title: "Business Advisory & Consulting",
      desc: "Provide strategic guidance to help businesses grow, optimize processes, and enhance financial performance.",
      btn: "Learn More",
    },
  ];
  ...
  const handleNavigate = (title: string) => {
    navigate("/auditing-details", { state: { type: title } });
  };
    ...
    py-10 md:py-20 px-6 md:px-24"
        >
          ...
          <div className="w-full md:w-1/2 text-center md:text-left max-w-xl order-2 md:order-1 md:pl-12 flex flex-col gap-4">
            ...
            <p className="text-base sm:text-lg md:text-lg font-lato mb-6 text-white">
              Efficient, accurate, and insightful auditing services{" "}
      ...
      <section className="py-12 bg-gray-50 w-full">
        <div className="px-4 sm:px-6 md:px-12 lg:px-24 xl:px-32">
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-center text-gray-800 mb-6 sm:mb-12 px-2 sm:px-6 md:px-0 lg:px-0 mx-auto leading-snug max-w-full lg:max-w-none">
            Experience the <span className="text-blue-600">expertise</span> with
            our <span className="text-pink-600">Auditing Services</span>
          </h2>

          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-12 justify-items-center">
...
export default AuditingMainPage;
