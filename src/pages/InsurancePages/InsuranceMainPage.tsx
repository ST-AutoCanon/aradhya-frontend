...
const InsuranaceMainPage = () => {
  const navigate = useNavigate();
  const auditServices = [
    {
      img: "images/2_Wheeler_Insurance.png",
      title: "Two Wheeler Insrurance",
      desc: "Get Additional Protection On Your 2 wheeler  with Add Ons Worth ₹6000 Only At ₹ 299.",
      btn: "Insure Now",
    },
    {
      img: "images/4_Wheeler_insurance.png",
      title: "Four Wheeler Insurance",
      desc: "Get Additional Protection On\nYour CarWith Add Ons Worth \n₹13500Only At ₹ 299.",
      btn: "Insure Now",
    },
    {
      img: "images/Term_Life_Insurance.png",
      title: "Term Life Insurance",
      desc: "Protect your loved ones with affordable term life insurance. Get financial security and peace of mind.",
      btn: "Insure Now",
    },
    {
      img: "images/Health_Insurance.png",
      title: "Health Insurance",
      desc: "Protect your entire family under a single comprehensive health insurance plan with lifetime ..",
      btn: "Insure Now",
    },
  ];
  const users: User[] = [
    ...
    py-10 md:py-20 px-6 md:px-24"
        >
          ...
          <div className="w-full md:w-1/2 text-center md:text-left max-w-xl order-2 md:order-1 md:pl-12 flex flex-col gap-4">
            ...
            <p className="text-base sm:text-lg md:text-lg font-lato mb-6 text-white">
              Protect your life, vehicle, and health with our{" "}
      ...
      <section className="py-12 bg-gray-50 w-full">
        <div className="px-4 sm:px-6 md:px-12 lg:px-24 xl:px-32">
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-center text-gray-800 mb-6 sm:mb-8 px-2 sm:px-6 md:px-0 lg:px-0 max-w-full lg:max-w-none mx-auto leading-snug">
            Feel the <span className="text-blue-600">best experience</span> with
            our <span className="text-pink-600">Insurance Services</span>
          </h2>
              ...
              >
                ...
                <div className="bg-gray-50 p-4 md:p-6 flex flex-col flex-grow justify-between">
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (item.title.includes("Two Wheeler"))
                        navigate("/insurance-details", {
                          state: { type: "Two Wheeler" },
                        });
                      else if (item.title.includes("Four Wheeler"))
                        navigate("/insurance-details", {
                          state: { type: "Four Wheeler" },
                        });
                      else if (item.title.includes("Term Life"))
                        navigate("/insurance-details", {
                          state: { type: "Term Life" },
                        });
                      else if (item.title.includes("Health"))
                        navigate("/insurance-details", {
                          state: { type: "Health" },
                        });
                    }}
...
export default InsuranaceMainPage;
